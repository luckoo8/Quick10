...
import 'card49_job_details_model.dart';
export 'card49_job_details_model.dart';

class Card49JobDetailsWidget extends StatefulWidget {
  const Card49JobDetailsWidget({super.key});

  @override
  State<Card49JobDetailsWidget> createState() => _Card49JobDetailsWidgetState();
}

class _Card49JobDetailsWidgetState extends State<Card49JobDetailsWidget>
    with TickerProviderStateMixin {
  late Card49JobDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Card49JobDetailsModel());

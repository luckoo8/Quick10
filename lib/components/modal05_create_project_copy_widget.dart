...
import 'modal05_create_project_copy_model.dart';
export 'modal05_create_project_copy_model.dart';

class Modal05CreateProjectCopyWidget extends StatefulWidget {
  const Modal05CreateProjectCopyWidget({super.key});

  @override
  State<Modal05CreateProjectCopyWidget> createState() =>
      _Modal05CreateProjectCopyWidgetState();
}

class _Modal05CreateProjectCopyWidgetState
    extends State<Modal05CreateProjectCopyWidget>
    with TickerProviderStateMixin {
  late Modal05CreateProjectCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modal05CreateProjectCopyModel());

...
import 'searches_model.dart';
export 'searches_model.dart';

class SearchesWidget extends StatefulWidget {
  const SearchesWidget({super.key});

  @override
  State<SearchesWidget> createState() => _SearchesWidgetState();
}

class _SearchesWidgetState extends State<SearchesWidget> {
  late SearchesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchesModel());

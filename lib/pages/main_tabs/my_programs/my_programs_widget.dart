...
import 'my_programs_model.dart';
export 'my_programs_model.dart';

class MyProgramsWidget extends StatefulWidget {
  const MyProgramsWidget({super.key});

  @override
  State<MyProgramsWidget> createState() => _MyProgramsWidgetState();
}

class _MyProgramsWidgetState extends State<MyProgramsWidget> {
  late MyProgramsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyProgramsModel());
                                                      ...
                                                      Expanded(
                                                        child: Padding(
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              AutoSizeText(
                                                                'Cracking The Ultimate Morse Code in 3 Easy Steps',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .titleMedium
                                                                    .override(

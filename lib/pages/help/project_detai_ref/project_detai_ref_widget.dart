...
import 'project_detai_ref_model.dart';
export 'project_detai_ref_model.dart';

class ProjectDetaiRefWidget extends StatefulWidget {
  const ProjectDetaiRefWidget({
    super.key,
    this.projectDetail,
  ...
  @override
  State<ProjectDetaiRefWidget> createState() => _ProjectDetaiRefWidgetState();
}

class _ProjectDetaiRefWidgetState extends State<ProjectDetaiRefWidget> {
  late ProjectDetaiRefModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProjectDetaiRefModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ProjectRecord>(
      stream: ProjectRecord.getDocument(widget.projectDetailRef!),
      builder: (context, snapshot) {
        ...
        final projectDetaiRefProjectRecord = snapshot.data!;
                              ...
                              children: [
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      14.0, 0.0, 0.0, 0.0),
                                  child: Text(
                                    projectDetaiRefProjectRecord.category,
                          ...
                          Row(
                            ...
                            children: [
                              if (valueOrDefault<bool>(
                                projectDetaiRefProjectRecord.format == '문자',
                                true,
                              ))
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                              ...
                              if (valueOrDefault<bool>(
                                projectDetaiRefProjectRecord.format == '통화',
                                false,
                              ))
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                ...
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          projectDetaiRefProjectRecord.title,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyLarge
                                              .override(
                                                fontFamily: 'Poppins',
                  ...
                  Container(
                    ...
                    child: StreamBuilder<List<ApplyRecord>>(
                      stream: queryApplyRecord(
                        parent: widget.projectDetailRef,
                      ),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                        if (!snapshot.hasData) {
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        var applyRecordReference =
                            ApplyRecord.createDoc(widget.projectDetailRef!);
                        ...
                        await widget.projectDetailRef!.update({
                          ...mapToFirestore(
                            {
                        ...
                        await UserProjectRecord.createDoc(
                                widget.projectDetail!.createdBy!)
                            .set({
                          ...createUserProjectRecordData(
                            projectInfo: widget.projectDetailRef,

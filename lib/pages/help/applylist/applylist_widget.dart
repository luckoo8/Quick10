...
import 'applylist_model.dart';
export 'applylist_model.dart';
...
class _ApplylistWidgetState extends State<ApplylistWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ApplylistModel());
      ...
      child: Column(
        ...
        children: [
          Align(
            ...
            child: Padding(
              padding: EdgeInsetsDirectional.fromSTEB(0.0, 10.0, 20.0, 5.0),
              child: InkWell(
